...
"""Supporting methods for forecasting pipeline.

MSBA team: This is called by some of the other files. You'll find some
  useful bits here. We need to clear out unused bits by the end.
